from crawlers.WeeklyBoxOfficeCrawler import WeeklyBoxOfficeCrawler
...
class WeeklyBoxOffice:
    ...
    def crawl(targetDt, multiMovieYn, repNationCd):
        box_office_results = WeeklyBoxOfficeCrawler(
            targetDt, multiMovieYn, repNationCd
        ).run()
        weekly_box_office_list = [
            WeeklyBoxOffice(**box_office_data) for box_office_data in box_office_results
        ]
        return weekly_box_office_list
