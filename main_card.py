...
post_daily_box_office_card(yesterday_date, None, "K")
post_daily_box_office_card(yesterday_date, None, "F")
post_daily_box_office_card(yesterday_date, "Y")
post_daily_box_office_card(yesterday_date, "Y", "K")
post_daily_box_office_card(yesterday_date, "Y", "F")
post_daily_box_office_card(yesterday_date, "N")
post_daily_box_office_card(yesterday_date, "N", "K")
post_daily_box_office_card(yesterday_date, "N", "F")
